...
// DiagnosticsRecorder stores instrumentation faults for assertions.
//
...
func (diagnostics *DiagnosticsRecorder) Report(_ context.Context, fault effect.RuntimeFault) {
...
func (diagnostics *DiagnosticsRecorder) Faults() []effect.RuntimeFault {
	diagnostics.mutex.Lock()
	defer diagnostics.mutex.Unlock()
